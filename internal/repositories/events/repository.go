...
// GetEventByUID récupère un event via (agendaId, uid)
...
// CreateEvent insère un event (clé logique: agenda_id + uid)
...
// UpdateEvent met à jour un event existant via (agenda_id + uid)
...
// DeleteEvent supprime un event via (agenda_id + uid)
