...
declare module '$env/static/private' {
	...
	export const SCYTHER_PACKAGE: string;
	...
	export const AVISPA_PACKAGE: string;
	...
	export const MAUDE_PACKAGE: string;
